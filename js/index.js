...
//new public Api -  bd9dd4ac3fb3520f36d1d5cd6442e78e
//MD5 -  85af5b885e1bf96da21683e05c8318bf
...
function getUrl() {
  ...
  //   if (!searchQuery) {
  //     console.log("Name cannot be empty!");
  //     return "http://gateway.marvel.com/v1/public/comics?ts=1&apikey=bd9dd4ac3fb3520f36d1d5cd6442e78e&hash=85af5b885e1bf96da21683e05c8318bf";
  //   } else {
  //     return `https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${searchQuery}&apikey=bd9dd4ac3fb3520f36d1d5cd6442e78e&hash=85af5b885e1bf96da21683e05c8318bf&ts=1`;
  //   }
}
